...
type NativeStyles = ViewStyle & TextStyle & ImageStyle;
...
export type ColorValue = RGB | RGBA | HEX | OpaqueColorValue;
...
> = {
  shadows?: {
    [key: string]: {
      shadowColor?: NativeStyles['shadowColor'];
      shadowOffset?: NativeStyles['shadowOffset'];
      shadowOpacity?: NativeStyles['shadowOpacity'];
      shadowRadius?: NativeStyles['shadowRadius'];
      elevation?: NativeStyles['elevation'];
    };
  };
  colors?: {
    // @ts-ignore
    [key in string]?: `var(--${keyof V})` | ColorValue;
  };
  sizes?: { [key: string]: DimensionValue };
  space?: { [key: string]: DimensionValue };
  borderWidths?: { [key: string]: NativeStyles['borderWidth'] };
  radii?: { [key: string]: NativeStyles['borderRadius'] };
  opacity?: { [key: string]: NativeStyles['opacity'] };
  lineHeights?: { [key: string]: NativeStyles['lineHeight'] };
  letterSpacings?: { [key: string]: NativeStyles['letterSpacing'] };
  fontWeights?: { [key: string]: number | undefined };
  fonts?: { [key: string]: NativeStyles['fontFamily'] };
  fontSizes?: { [key: string]: NativeStyles['fontSize'] };
};
